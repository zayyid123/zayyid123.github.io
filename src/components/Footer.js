...
const Footer = () => {
  ...
  return (
    <div className="bg-bg-100 w-full">
      <div className="max-w-6xl m-auto pt-28 pb-8 px-5">
        <div className="flex justify-center md:justify-between items-center md:items-start mb-16 flex-col md:flex-row gap-8">
        ...
        <div>
          <div className="text-[#b7b7b7] text-center mt-4">
            Copyright © {getYear()} Zayyid. All Rights Reserved.
          </div>
        </div>
      </div>
    </div>
